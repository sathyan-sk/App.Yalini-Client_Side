...
interface StatusSelectorProps {
  ...
  onChange: (next: VehicleStatusId) => void;
  testID?: string;
}

/**
 * Enabled/Disabled toggle buttons matching the Hotel design exactly.
  ...
  return (
    <View style={styles.container} testID={testID}>
      ...
      <Text style={styles.helperText}>
        🚗 Enabled vehicles will be available for use.{"\n"}
        🚫 Disabled vehicles will be unavailable for use.
      </Text>
    </View>
  );
}
